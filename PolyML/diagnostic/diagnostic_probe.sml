...
val _ = print "✓ Thread.Mutex.mutex() works\n";
val _ = print "✓ Thread.Mutex.lock exists\n";
val _ = print "✓ Thread.Mutex.unlock exists\n\n";
...
val cvTest1 = 
  (let val _ = Thread.ConditionVar.conditionVar () in "✓ conditionVar() works" end)
  handle _ => "✗ conditionVar() failed";
val _ = print (cvTest1 ^ "\n");

val _ = print "Attempting: Thread.ConditionVar.condVar()...\n";
val cvTest2 = 
  (let val _ = Thread.ConditionVar.condVar () in "✓ condVar() works" end)
  handle _ => "✗ condVar() failed";
val _ = print (cvTest2 ^ "\n\n");
...
val forkTest1 = 
  (let 
   ...
   in "✓ Thread.fork works" end)
  handle _ => "✗ Thread.fork failed";
...
val forkTest2 = 
  (let 
   ...
   in "✓ Thread.Thread.fork works" end)
  handle _ => "✗ Thread.Thread.fork failed";
